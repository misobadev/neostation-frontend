...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.rommLinkRow: 'RomM にリンク',
  AppLocale.rommLinkRowSubtitle: 'RomM ライブラリを検索して、このゲームに対応する ROM を選択します',
  AppLocale.rommLinkAction: 'リンク',
  AppLocale.rommUnlinkRow: 'RomM とのリンクを解除',
  AppLocale.rommUnlinkRowSubtitle: 'リンクを削除します。次回接続時にファイル名で再度リンクされることがあります',
  AppLocale.rommUnlinkAction: '解除',
  AppLocale.rommUnlinkConfirmTitle: 'RomM とのリンクを解除しますか？',
  AppLocale.rommUnlinkConfirmBody: 'このゲームのセーブデータは {name} と同期されなくなります。',
  AppLocale.rommLinkStateNotLinked: 'RomM にリンクされていません',
  AppLocale.rommLinkStateAuto: '{name} に自動でリンク済み',
  AppLocale.rommLinkStateManual: '{name} に手動でリンク済み',
  AppLocale.rommLinkPickerTitle: 'RomM の ROM にリンク',
  AppLocale.rommLinkPickerSearchHint: 'RomM ライブラリを検索',
  AppLocale.rommLinkPickerLoading: '検索中…',

...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.rommLinkLibrary: '라이브러리를 RomM에 연결',
  AppLocale.rommLinkLibrarySubtitle: '로컬 롬을 RomM 서버와 대조하여 연결합니다',
  AppLocale.rommLinkLibraryWarning:
      'RomM 서버의 모든 플랫폼을 살펴보고 인식된 로컬 롬을 연결합니다.\n\n연결된 게임은 저장 데이터 동기화 대상이 되므로 저장 데이터가 RomM으로 업로드됩니다. 라이브러리가 크면 몇 분이 걸릴 수 있습니다.',
  AppLocale.rommLinkLibraryPreparing: '준비 중…',
  AppLocale.rommLinkLibraryProgress: '{total}개 중 {done}개 — {system}',
  AppLocale.rommLinkLibraryDone: '게임 {count}개를 연결했습니다',
  ...
  AppLocale.rommLinkRow: 'RomM에 연결',
  AppLocale.rommLinkRowSubtitle: 'RomM 라이브러리를 검색해 이 게임에 해당하는 ROM을 선택합니다',
  AppLocale.rommLinkAction: '연결',
  AppLocale.rommUnlinkRow: 'RomM 연결 해제',
  AppLocale.rommUnlinkRowSubtitle: '연결을 제거합니다. 이후 접속 시 파일 이름으로 다시 연결될 수 있습니다',
  AppLocale.rommUnlinkAction: '해제',
  AppLocale.rommUnlinkConfirmTitle: 'RomM 연결을 해제할까요?',
  AppLocale.rommUnlinkConfirmBody: '이 게임의 세이브가 더 이상 {name}와(과) 동기화되지 않습니다.',
  AppLocale.rommLinkStateNotLinked: 'RomM에 연결되지 않음',
  AppLocale.rommLinkStateAuto: '{name}에 자동으로 연결됨',
  AppLocale.rommLinkStateManual: '{name}에 수동으로 연결됨',
  AppLocale.rommLinkPickerTitle: 'RomM ROM에 연결',
  AppLocale.rommLinkPickerSearchHint: 'RomM 라이브러리 검색',
